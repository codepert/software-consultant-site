...
const SkillIcon = ({ src, name }: Props) => {
  return (
    <div className="relative grid text-2xl shadow-md bg-bg-secondary dark:shadow-xl h-14 w-14 sm:h-16 sm:w-16 place-items-center group">
      <Icon icon={src} width="42" height="42" />
